...
export type PunclineClientSocket = Socket<ServerToClientEvents, ClientToServerEvents>;

const API_URL = process.env.NEXT_PUBLIC_API_URL ?? 'http://localhost:3001';

let instance: PunclineClientSocket | null = null;
 ...
 */
export function getSocket(): PunclineClientSocket {
  if (instance === null) {
    instance = io(API_URL, {
      autoConnect: false,
